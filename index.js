...
module.exports = app => {
  ...
  app.on('check_run.completed', async context => {
    ...
    const duration =
      new Date(context.payload.check_run.completed_at) -
      new Date(context.payload.check_run.started_at);
    ...
    app.log(
      'observation.check_run_conclusion -> ' + observation.check_run_conclusion
    );
    app.log(
      'observation.repository_full_name -> ' + observation.repository_full_name
    );
